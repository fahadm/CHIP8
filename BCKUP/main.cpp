  ...
  void DecodeOpCode(unsigned short int opcode)
  {
    ...
    switch(opcode>>12)
      ...
      case 2:
        ...
        break;
      case 3:
        if (Reg.V[((tempholder&0x0F00)>>8)] == (tempholder&0x00FF))
          Reg.PC+=2;
        break;
      case 4:
        if (Reg.V[((tempholder&0x0F00)>>8)] != (tempholder&0x00FF))
        ...
        break;
      case 5:
        if (Reg.V[((tempholder&0x0F00)>>8)] == Reg.V[((tempholder&0x00F0)>>4)])
          Reg.PC+=2;

        break;
      case 6:
        Reg.V[((tempholder&0x0F00)>>8)] = (tempholder&0x00FF);
        break;
      case 7:
        Reg.V[((tempholder&0x0F00)>>8)] += (tempholder&0x00FF);
        break;
      case 8:
        switch (tempholder&0xf)
          {
          case 0 :
            Reg.V[((tempholder&0x0F00)>>8)] = Reg.V[((tempholder&0x00F0)>>4)];
            break;
          case 1:
            Reg.V[((tempholder&0x0F00)>>8)] |= Reg.V[((tempholder&0x00F0)>>4)];
            break;
          ...
          case 4:
            ...
            tem=  Reg.V[((tempholder&0x0F00)>>8)]  + Reg.V[((tempholder&0x00F0)>>4)];
            if (tem > 255) Reg.V[0xf] =1;
            else Reg.V[0xf] =0;
            Reg.V[((tempholder&0x0F00)>>8)] = (tem&0xff );
            break;
          case 5:
